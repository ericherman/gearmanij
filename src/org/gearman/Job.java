...
/**
 * A Job is the unit of work for Gearman. Clients submit jobs to the job server
 * and the job server distributes jobs to workers.
 */
public interface Job {
    ...
    /**
     * Returns the ID assigned to the job by the client. Not all Jobs have
     * client- assigned IDs.
     * 
